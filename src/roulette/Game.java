...
public class Game {
	...
	private Bet[] myPossibleBets = { new RedOrBlack(1), new OddOrEven(1), new ThreeInARow(11) };
	 ...
	 *
	 * Prompt player to make a bet, then spin the roulette wheel, and then
	 * verify that the bet is won or lost.
	 *
	 * @param player
	...
	public void play(Gambler player) {
		...
		if (myPossibleBets[whichBet].betIsMade(myWheel, betChoice)) {
